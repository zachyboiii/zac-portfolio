...
const experience_data = [
  {
    id: "ocbc",
    e_company: "OCBC Bank",
    e_role: "AI and Mobile Engineer Intern",
    e_type: "Internship",
    e_date: "May 2026 – Present",
    e_desc: "Contributing to OCBC WoW, an AI avatar banking app for wealth clients — building agentic RAG workflows with LangGraph that power personalised portfolio insights and market updates, alongside iOS development in Swift.",
    e_skills: ["RAG", "LangGraph", "Agentic AI", "Amazon Bedrock","Vector DB", "FastAPI", "PostgreSQL", "Swift"],
    e_link: "https://fintechnews.sg/133885/wealthtech/ocbc-avatar-banking/",
    e_current: true,
  },
  {
    id: "edgemaker",
    ...
    e_skills: ["Next.js", "Node.js", "Springboot", "Redis", "Agentic AI", "Prompt Engineering", "Git"],
    e_link: "",
    e_current: false,
  },
  {
